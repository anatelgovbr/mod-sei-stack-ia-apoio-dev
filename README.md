...
- `AGENTS.md`, com diretrizes, guardrails, escopo de escrita e regras de decisão e `.agents/skills/`, com as skills compartilhadas do projeto
  - URL fonte: xxxxx
  - URL fonte: xxxxx
- SDD com SpecKit mantido pelo GitHub, já versionado e pronto para uso no próprio repositório:
  - Site do Projeto: wwww
  - Repositório do Projeto: wwww
...
## Estrutura da Stack no Framework de SDD SpecKit

...
Cobre os 4 tipos de entidade: standalone, 1:N, 1:1 e N:N.
...
| dta_cadastramento | datetime | — | Sim | — | — | — |
...
create table md_abc_contrato (
  ...
  dta_assinatura      datetime       not null,
...
create table md_abc_rel_contrato_projeto (
  id_md_abc_contrato integer  not null,
  id_md_abc_projeto  integer  not null,
  dta_associacao     datetime not null
);

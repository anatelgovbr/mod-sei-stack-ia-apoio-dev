...
class MdAbcResponsavelRN extends InfraRN
{
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_cadastrar', __METHOD__, $objMdAbcResponsavelDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_alterar', __METHOD__, $objMdAbcResponsavelDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_excluir', __METHOD__, $arrObjMdAbcResponsavelDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_consultar', __METHOD__, $objMdAbcResponsavelDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_listar', __METHOD__, $objMdAbcResponsavelDTO);
...
/*   protected function desativarControlado(array $arrObjMdAbcResponsavelDTO): void
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_desativar', __METHOD__, $arrObjMdAbcResponsavelDTO);
...
/*   protected function reativarControlado(array $arrObjMdAbcResponsavelDTO): void
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_responsavel_reativar', __METHOD__, $arrObjMdAbcResponsavelDTO);

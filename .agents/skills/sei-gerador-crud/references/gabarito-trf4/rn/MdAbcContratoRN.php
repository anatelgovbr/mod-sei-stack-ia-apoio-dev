...
class MdAbcContratoRN extends InfraRN
{
  ...
  private function validarNumIdMdAbcAquisicao(MdAbcContratoDTO $objMdAbcContratoDTO, InfraException $objInfraException): void
  {
    if (InfraString::isBolVazia($objMdAbcContratoDTO->getNumIdMdAbcAquisicao())) {
      $objInfraException->adicionarValidacao('Aquisição não informado.');
    }
  }
  ...
  private function validarDtaAssinatura(MdAbcContratoDTO $objMdAbcContratoDTO, InfraException $objInfraException): void
  {
    if (InfraString::isBolVazia($objMdAbcContratoDTO->getDtaAssinatura())) {
      $objInfraException->adicionarValidacao('Data de Assinatura não informado.');
    } elseif (!InfraData::validarData($objMdAbcContratoDTO->getDtaAssinatura())) {
      $objInfraException->adicionarValidacao('Data de Assinatura inválida.');
    }
  }
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_cadastrar', __METHOD__, $objMdAbcContratoDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_alterar', __METHOD__, $objMdAbcContratoDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_excluir', __METHOD__, $arrObjMdAbcContratoDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_consultar', __METHOD__, $objMdAbcContratoDTO);
  ...
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_listar', __METHOD__, $objMdAbcContratoDTO);
...
/*   protected function desativarControlado(array $arrObjMdAbcContratoDTO): void
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_desativar', __METHOD__, $arrObjMdAbcContratoDTO);
...
/*   protected function reativarControlado(array $arrObjMdAbcContratoDTO): void
  {
    try {
      SessaoSEI::getInstance()->validarAuditarPermissao('md_abc_contrato_reativar', __METHOD__, $arrObjMdAbcContratoDTO);

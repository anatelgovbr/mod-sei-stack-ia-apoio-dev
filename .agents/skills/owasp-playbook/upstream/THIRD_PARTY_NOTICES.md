...
| [OWASP FIASSE v1.0.4](https://github.com/OWASP/FIASSE/blob/v1.0.4/docs/securable_framework.md) | CC BY-SA 4.0 | Code attribute and securable principle references (see also `data/fiasse/`) |

...
2. **Consultar a classe de entrada/saida** no catalogo da `sei-mod-api` (`references/catalogo-api.md`) para saber quais campos sao necessarios.
...
- [ ] Os objetos de entrada/saida usado correspondem ao contrato oficial documentado na `sei-mod-api`.
...
- Classes API (entrada/saida): `sei-mod-api` / `references/catalogo-api.md`
- Manual SEI cap 10: `docs/manual_desenvolvimento_md/sei_modulos_manual_dev_10_operacoes.md`
- Para verificar se existe operacao oficial antes de implementar: `sei-mod-api`

...
```bash
cd .agents/skills/sei-verificacao-banco-dados && python3 -m unittest test_audit
```

14 testes sobre `audit.py`. O arquivo e independente de proposito: nao importa helper de

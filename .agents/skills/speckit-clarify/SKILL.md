...
`{SCRIPT}` refers to the setup script declared in this skill's frontmatter under `scripts`. Pick the entry that matches the shell you are running in, and run it from the repository root:

...
|---|---|---|---|
| 1 | Nome de tabela segue o padrao do modulo e permanece dentro dos limites de tamanho | `R1`, `R3`, `R15` | BLOQUEANTE |
| 2 | Relacionamento N:N usa tabela `md_<sigla>_rel_<a>_<b>` quando o conceito nao exigir nome proprio do dominio | `R2` | BLOQUEANTE |
| 3 | Tabelas e colunas ficam em ate `26` caracteres; indices, FKs e sequences em ate `30` | `R3`, `R5`, `B3`, `B4` | BLOQUEANTE |
| 4 | PK, FK, AK e sequence seguem naming coerente e portavel | `R4`, `R5`, `R7`, `R10`, `R11` | BLOQUEANTE/AVISO |
| 5 | Tipos SQL sao portaveis entre MySQL, SQL Server, Oracle e PostgreSQL | `R8`, `B1` | BLOQUEANTE |
| 6 | FKs relevantes possuem indice explicito ou helper equivalente | `R9` | AVISO |
| 7 | Tabelas e colunas possuem descricao negocial em `comment`; docblock em DTO e evidencia auxiliar local, nao substituto do metadado do banco | manual cap. 5 `Regras Gerais`, `R12` | AVISO |
